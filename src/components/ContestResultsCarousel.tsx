          ...
          >
            {duplicatedContests.map((contest, index) => (
              <a
                ...
                className="flex-shrink-0 block w-[54vw] sm:w-[315px] md:w-[360px]"
                aria-label={`View ${contest.contest} details`}
              >
                <Card 
                  className="h-full bg-card/60 backdrop-blur cyber-border hover:cyber-glow-box transition-all duration-300 group"
                >
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div 
                      className="flex items-center gap-2 text-xs sm:text-sm text-muted-foreground group-hover:text-primary transition-colors mt-4"
                    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 justify-items-center">
          {judgingCards.map((judging, index) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-[255px] md:w-[330px] block"
              aria-label={`View ${judging.name} details`}
            >
              <Card 
                className="h-full bg-card/50 backdrop-blur cyber-border hover:cyber-glow-box transition-all duration-300 group"
              >
                <CardHeader className="pb-4">
                  <div className="flex justify-between items-start mb-4">
                    <img
